...
const UserSettings = React.lazy(() => import(/* webpackPrefetch: true */ 'components/user_preferences'));
const ModalSidebar = React.lazy(() => import(/* webpackPrefetch: true */ 'components/widgets/modals/genric/modal_sidebar'));
...
function UserSettingsModal(props: Props): JSX.Element {
    ...
    const [activeTab, setActiveTab] = useState<string>(props.isContentProductSettings ? 'themes' : 'Info');
    ...
    const tabs = useUserSettingsTabs(props.isContentProductSettings);
                ...
                <div className='user-settings-modal___body'>
                    ...
                    <div className='user-settings-modal__content'>
                        <React.Suspense fallback={null}>
                            <Provider store={store}>
                                <UserSettings
                                    isContentProductSettings={props.isContentProductSettings}
                                    activeTab={activeTab}
