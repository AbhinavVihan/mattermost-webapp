...
import {Tab} from '../widgets/modals/genric/modal_sidebar';
...
export const holders = defineMessages({
    ...
    Info: {
        id: t('user.settings.modal.Info'),
        defaultMessage: 'Info',
    }
});
export function useUserSettingsTabs(isContentProductSettings: boolean): Tab[] {
        ...
        return [
            {
                icon: (
                    ...
                    />),
                name: 'Info',
                uiName: formatMessage(holders.Info),
            },
            {
                icon: (
                    <InformationOutlineIcon
